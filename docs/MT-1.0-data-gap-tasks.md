> 2026-09-11 续办更新：以下为原第三轮历史状态，不再代表当前缓存覆盖。全源归并/全窗口回填后目标缺口为2,498、250日暖启动缺口为7,166；PIT和结算仍阻断。详见 `MT-1.0-work-0754-delivery.md` 与 `MT-1.0-work-0754-evidence.json`。
